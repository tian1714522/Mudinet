...
E_model = os.path.join(E_save_model, 'PM_VT_AP3468_260122_1-4.pkl')
...
def main():
    ...
    VT = MultiTaskVT(hidden_dim=256,nhead=8,num_layers=1,
                     global_latent_dim1=16,global_latent_dim2=16,local_latent_dim=16,cir_dim=400).cuda()
    ...
    log_pointer = open(os.path.join(E_save_log, 'PM_VT_AP3468_260122_1-4.txt'), 'w')
